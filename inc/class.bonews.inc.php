...
// 		}
		...
		function send_mail($news)
		{
			...
			// build body
			$body  = '';
			$body .= lang('URL') . ": http://" . $GLOBALS['egw_info']['server']['hostname'] . "<br/>";
			...
			$tempdata = explode ( "," , $GLOBALS['egw']->common->grab_owner_name($news['submittedby']));
			$tempfromname = "";
			foreach($tempdata as $tempname) 
			{
				$tempfromname .= ' ' . $tempname;
			}
